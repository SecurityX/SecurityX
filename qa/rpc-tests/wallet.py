...
#   c) node1 mines 32 blocks, so now node 0 has 60001secx, node 1 has 4250secx, node2 has none.
#   d) node0 sends 601 secx to node2, in two transactions (301 secx, then 300 secx).
