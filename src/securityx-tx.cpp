...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SecurityX Core securityx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  securityx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded securityx transaction") + "\n" +
                               "  securityx-tx [options] -create [commands]   " + _("Create hex-encoded securityx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded securityx transaction
