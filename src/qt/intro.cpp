...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SecurityX Core"),
     ...
     * override -datadir in the securityx.conf file in the default data directory
     * (to be consistent with securityxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
