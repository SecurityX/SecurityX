...
/** Utility functions used by the SecurityX Qt UI.
 */
namespace GUIUtil
{
...
// Render SecurityX addresses in monospace font
...
// Parse "securityx:" URI into recipient object, return true on successful parsing
