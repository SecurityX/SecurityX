...
/* SecurityX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SecurityX"
#define QAPP_ORG_DOMAIN "securityx.us"
#define QAPP_APP_NAME_DEFAULT "SecurityX-Qt"
#define QAPP_APP_NAME_TESTNET "SecurityX-Qt-testnet"
