...
/**
 * SecurityX RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzsecxseed(const UniValue& params, bool fHelp);
extern UniValue getzsecxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsecx(const UniValue& params, bool fHelp);
extern UniValue dzsecxstate(const UniValue& params, bool fHelp);
