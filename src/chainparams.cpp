...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "securityx.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "securityx.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "securityx-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "securityx-testnet.seed2.fuzzbawls.pw"));
