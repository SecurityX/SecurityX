...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 4142;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SecurityX starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SecurityX: 1 day
        ...
        vSeeds.push_back(CDNSSeedData("seed1.securityx.us", "seed1.securityx.us"));           // Single node address
        vSeeds.push_back(CDNSSeedData("seed2.securityx.us", "seed2.securityx.us"));           // Single node address
        vSeeds.push_back(CDNSSeedData("seed3.securityx.us", "seed3.securityx.us"));           // Single node address
        vSeeds.push_back(CDNSSeedData("seed4.securityx.us", "seed4.securityx.us"));           // Single node address
        vSeeds.push_back(CDNSSeedData("seed5.securityx.us", "seed5.securityx.us"));           // Single node address
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zsecx to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("test1.securityx.us", "test1.securityx.us"));
        vSeeds.push_back(CDNSSeedData("test2.securityx.us", "test2.securityx.us"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140); // Testnet securityx addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 21);  // Testnet securityx script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet securityx BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet securityx BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet securityx BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // SecurityX: 1 day
        nTargetSpacing = 1 * 60;        // SecurityX: 1 minutes
