...
In order to support loading of multiple wallets in securityx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is securityx.cpp.
...
Changes to securityx.cpp
----------------------
securityx.cpp is the entry point into securityx-qt, and as such, will require some minor modifications to provide hooks for
