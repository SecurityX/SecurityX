...
This mechanism has been integrated into Bitcore-Node-SecurityX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SecurityX/insight-api-securityx#web-socket-api](https://github.com/SecurityX/insight-api-securityx#web-socket-api) 
* API: [https://github.com/SecurityX/insight-api-securityx#swifttx-transactions](https://github.com/SecurityX/insight-api-securityx#swifttx-transactions) 
...
By default, the SecurityX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SecurityX Core daemon:
