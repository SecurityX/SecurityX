Contributing to SecurityX Core
============================

The SecurityX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SecurityX Core project, and is not to be
confused with overall SecurityX Network Protocol consensus changes.

Whether a pull request is merged into SecurityX Core rests with the project merge
...
Patches that change SecurityX consensus rules are considerably more involved than
...
Where a patch set proposes to change the SecurityX consensus, it must have been
...
The project leader is the release manager for each SecurityX Core release.
