...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/securityx-cli.cpp \
           src/securityx-tx.cpp \
           src/securityx.cpp \
           src/db.cpp \
           ...
           src/qt/securityx.cpp \
           src/qt/securityxstrings.cpp \
...
RESOURCES += src/qt/securityx.qrc src/qt/securityx_locale.qrc

TRANSLATIONS += src/qt/locale/securityx_bg.ts \
                src/qt/locale/securityx_de.ts \
                src/qt/locale/securityx_en.ts \
                src/qt/locale/securityx_es.ts \
                src/qt/locale/securityx_fi.ts \
                src/qt/locale/securityx_fr.ts \
                src/qt/locale/securityx_it.ts \
                src/qt/locale/securityx_ja.ts \
                src/qt/locale/securityx_pl.ts \
                src/qt/locale/securityx_pt.ts \
                src/qt/locale/securityx_ru.ts \
                src/qt/locale/securityx_sk.ts \
                src/qt/locale/securityx_sv.ts \
                src/qt/locale/securityx_vi.ts \
                src/qt/locale/securityx_zh_CN.ts \
                src/qt/locale/securityx_zh_TW.ts
